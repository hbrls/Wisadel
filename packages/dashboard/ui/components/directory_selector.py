...
class DirectorySelectorBuilder:
    ...
    def build(
        ...
        self.button.clicked.connect(
            lambda: self._on_select_directory(parent, default_value, on_select_callback, placeholder_text)
        )
    ...
    def _on_select_directory(
        ...
        parent: QObject,
        initial_path: str,
        on_select_callback: Optional[Callable[[str], None]],
        ...
        if selected_dir:
            ...
            logger.info(f"目录已选择: {selected_dir}")
            if on_select_callback:
                on_select_callback(selected_dir)
